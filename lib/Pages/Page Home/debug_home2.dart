...
import 'package:flutter_food_app/Components/c_homeCard1.dart';
...
class DebugHome2 extends StatefulWidget {
  const DebugHome2({Key? key}) : super(key: key);

  @override
  _DebugHome2State createState() => _DebugHome2State();
}

class _DebugHome2State extends State<DebugHome2> {
  @override
